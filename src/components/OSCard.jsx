...
export default function OSCard({ os, handleDragStart, handleUpdateDate, handleUpdateField, handleUpdateStatus, handleDelete, verHistorico, listaTecnicos, sendWhatsApp }) {
  
  return (
    <div 
      draggable 
      onDragStart={(e) => handleDragStart(e, os)}
      className="p-3 bg-white rounded-lg shadow-sm border border-gray-200 mb-3 hover:shadow-md cursor-grab active:cursor-grabbing border-l-4 hover:border-l-[#EB6410]"
    >
